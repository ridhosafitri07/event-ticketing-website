...
<body class="dashboard-body">
    ...
    <!-- Navbar - yeayy udah responsive nih! 💕 -->
    <nav class="navbar">
        <div class="nav-container">
            ...
            <!-- Hamburger menu buat mobile (biar kece) 🍔 -->
    ...
    <div class="container">
        ...
        <button class="btn-toggle-filter" onclick="toggleFilter()">
            ...
            <span class="filter-text">Filter & Cari Event</span>
            <span class="filter-arrow" id="filterArrow">▼</span>
        </button>
        
        <div class="filter-search-section" id="filterSection">
    ...
    <script>
         ...
         * Show/hide filter section di mobile
         */
                ...
                <form id="bookingForm" onsubmit="submitBooking(event, ${eventId})">
                    ...
                    <div id="ccDetails" style="display: none;">
                        <div class="payment-info-box">
                            <p>💳 Pembayaran dengan Kartu Kredit akan diproses melalui payment gateway.</p>
        ...
        function saveBooking(event, currentUser, ticketCount, totalPrice, paymentDetails, eventId) {
            ...
            // ⭐ PENTING: Ambil data bookings yang sudah ada
            let bookings = JSON.parse(localStorage.getItem('bookings')) || [];
            
            // ⭐ PENTING: Tambahkan booking baru
            bookings.push(newBooking);
            
            // ⭐ PENTING: Simpan ke localStorage dengan key 'bookings'
        ...
        function showBookingConfirmation(booking, currentUser, event, ticketCount, totalPrice, paymentDetails) {
            ...
            if (paymentDetails.method === 'transfer') {
                paymentInfo = `
                    <p style="color: #CBD5E1;"><strong style="color: #F1F5F9;">Bank Tujuan:</strong> ${paymentDetails.bank}</p>
                    <p style="color: #CBD5E1;"><strong style="color: #F1F5F9;">Dari Rekening:</strong> ${paymentDetails.accountName} (${paymentDetails.accountNumber})</p>
                    <p style="color: #CBD5E1;"><strong style="color: #F1F5F9;">Bukti Transfer:</strong> <span style="color: #10B981;">✅ Sudah diupload</span></p>
                `;
            } else if (paymentDetails.method === 'ewallet') {
                paymentInfo = `
                    <p style="color: #CBD5E1;"><strong style="color: #F1F5F9;">E-Wallet:</strong> ${paymentDetails.ewalletType}</p>
                    <p style="color: #CBD5E1;"><strong style="color: #F1F5F9;">Nomor:</strong> ${paymentDetails.ewalletNumber}</p>
                    <p style="color: #CBD5E1;"><strong style="color: #F1F5F9;">Bukti Bayar:</strong> <span style="color: #10B981;">✅ Sudah diupload</span></p>
                `;
            } else if (paymentDetails.method === 'cc') {
                paymentInfo = `<p style="color: #CBD5E1;"><strong style="color: #F1F5F9;">💳 Kartu Kredit</strong> - Menunggu verifikasi</p>`;
            }

            const confirmationHtml = `
                <div class="confirmation">
                    <div class="confirmation-icon">✅</div>
                    <h2 style="color: #F1F5F9;">Pemesanan Berhasil!</h2>
                    <p style="color: #94A3B8;">Terima kasih telah memesan tiket</p>
                    
                    <div class="booking-details">
                        <p style="color: #CBD5E1;"><strong style="color: #F1F5F9;">No. Booking:</strong> ${booking.bookingNumber}</p>
                        <p style="color: #CBD5E1;"><strong style="color: #F1F5F9;">Nama:</strong> ${currentUser.name}</p>
                        <p style="color: #CBD5E1;"><strong style="color: #F1F5F9;">Email:</strong> ${currentUser.email}</p>
                        <p style="color: #CBD5E1;"><strong style="color: #F1F5F9;">Event:</strong> ${event.title}</p>
                        <p style="color: #CBD5E1;"><strong style="color: #F1F5F9;">Jumlah Tiket:</strong> ${ticketCount} tiket</p>
                        <p style="color: #CBD5E1;"><strong style="color: #F1F5F9;">Total Bayar:</strong> Rp ${totalPrice.toLocaleString('id-ID')}</p>
                        <p style="color: #CBD5E1;"><strong style="color: #F1F5F9;">Metode Pembayaran:</strong> ${paymentLabel}</p>
                        ${paymentInfo}
                        <p style="color: #CBD5E1;"><strong style="color: #F1F5F9;">Status:</strong> <span style="color: #FCD34D; font-weight: 600;">🟡 Menunggu Verifikasi</span></p>
                    </div>

                    <p style="color: #94A3B8; font-size: 14px; margin: 15px 0; line-height: 1.6;">
