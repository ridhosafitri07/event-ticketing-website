...
<div class="auth-container" style="position: relative; z-index: 1;">
    <div class="auth-header">
        ...
        <p>Mulai petualangan event kamu bersama EventKu</p>
    </div>
    ...
    <form action="<?= base_url('auth/doRegister') ?>" method="POST" class="auth-form">
        ...
        <div class="form-group">
            ...
            <input type="tel" id="phone" name="phone" placeholder="08123456789" value="<?= old('phone') ?>" required>
        </div>
    ...
    <div class="auth-footer">
        <p>Sudah punya akun? <a href="<?= base_url('auth/login') ?>" class="link-primary">Login di sini</a></p>
    </div>
</div>
