...
<div class="auth-container" style="position: relative; z-index: 1;">
    <div class="auth-header">
        ...
        <p>Login ke akun EventKu kamu</p>
    </div>
    ...
    <form action="<?= base_url('auth/doLogin') ?>" method="POST" class="auth-form">
        ...
        <div class="form-options">
            ...
            <a href="<?= base_url('auth/forgotPassword') ?>" class="forgot-link">Lupa password?</a>
        </div>
    ...
    <div class="auth-footer">
        <p>Belum punya akun? <a href="<?= base_url('auth/register') ?>" class="link-primary">Daftar sekarang</a></p>
    </div>
</div>
...
.particle:nth-child(3) { left: 50%; animation-delay: 10s; background: #EC4899; box-shadow: 0 0 10px #EC4899; }
.auth-container {
    max-width: 440px;
    width: 100%;
...
.forgot-link { color: #A78BFA; text-decoration: none; transition: color 0.2s; }
